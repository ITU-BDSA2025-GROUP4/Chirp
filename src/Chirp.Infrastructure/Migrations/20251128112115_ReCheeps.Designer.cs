...
namespace Chirp.Infrastructure.Migrations
{
    ...
    [Migration("20251128112115_ReCheeps")]
    partial class ReCheeps
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chirp.Core.Entities.Cheep", b =>
                {
                    ...
                    b.ToTable("Cheeps", t =>
                        {
                            t.HasCheckConstraint("ck_cheep_text_length", "length(text) <= 160");
                        });
                });
            ...
            modelBuilder.Entity("Chirp.Core.Entities.ReCheep", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Chirp.Core.Entities.Reply", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
